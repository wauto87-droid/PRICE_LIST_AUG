...
export default function MaintenanceBanner({
  ...
  const phone = supportMobile || "+966 11 000 0000";
    ...
    <div className="maintenance-screen" dir={isAr ? "rtl" : "ltr"}>
      ...
      <header className="maintenance-nav">
        <div className="maintenance-brand">
          <div className="maintenance-logo-mark" aria-hidden="true">
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
            </svg>
          </div>
          <div className="maintenance-brand-text">
            <span className="maintenance-brand-name">AMT ELECTRIC</span>
            <span className="maintenance-brand-sub">{t("Electrical Supplies", "للمواد الكهربائية")}</span>
          </div>
        </div>
      ...
      <main className="maintenance-content">
        <div className="maintenance-card">
          ...
          <div className="maintenance-status-badge">
            ...
            <span>{t("Maintenance Mode Active", "وضع الصيانة قيد التشغيل")}</span>
          </div>
          ...
          {image ? (
            ...
            <div className="maintenance-hero-icon" onDoubleClick={onBypass} title={onBypass ? t("Double click for staff bypass", "انقر مرتين لدخول الموظفين") : undefined}>
          ...
          <p className="maintenance-description">{displayText}</p>
          ...
          <div className="maintenance-autorecovery-box">
            ...
            <div className="maintenance-autorecovery-text">
              ...
              <span>{t("This page is actively monitoring the server and will unlock immediately once maintenance ends — no refresh needed.", "تراقب هذه الصفحة حالة الخادم تلقائياً وستفتح فور انتهاء أعمال الصيانة دون الحاجة لتحديث الصفحة.")}</span>
            </div>
          </div>
          ...
          <div className="maintenance-footer-actions">
            ...
            >
              ...
              <span>{t("Contact via WhatsApp", "تواصل عبر واتساب")}</span>
            </a>
