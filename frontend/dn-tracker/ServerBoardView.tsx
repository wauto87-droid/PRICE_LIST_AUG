...
export default function ServerBoardView({rows,counts,t,editable,open,move}: {rows:any[];counts:any[];t:Translate;editable:boolean;open:(id:string)=>void;move:(note:any,stage:string)=>void}) {
